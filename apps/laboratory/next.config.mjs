...
const cspHeader = `
  ...
  frame-src 'self' https://verify.walletconnect.com http://localhost:3000 https://verify.walletconnect.org https://secure.walletconnect.com https://secure.walletconnect.org ${
